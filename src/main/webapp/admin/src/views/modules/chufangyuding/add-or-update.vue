<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="厨房编号" prop="chufangbianhao">
          <el-input v-model="ruleForm.chufangbianhao" 
              placeholder="厨房编号" clearable  :readonly="ro.chufangbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="厨房编号" prop="chufangbianhao">
              <el-input v-model="ruleForm.chufangbianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预订定金" prop="yudingdingjin">
          <el-input v-model="ruleForm.yudingdingjin" 
              placeholder="预订定金" clearable  :readonly="ro.yudingdingjin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预订定金" prop="yudingdingjin">
              <el-input v-model="ruleForm.yudingdingjin" 
                placeholder="预订定金" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否预订" prop="shifouyuding">
          <el-select v-model="ruleForm.shifouyuding" placeholder="请选择是否预订">
            <el-option
                v-for="(item,index) in shifouyudingOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否预订" prop="shifouyuding">
	      <el-input v-model="ruleForm.shifouyuding"
                placeholder="是否预订" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="预订时长" prop="yudingshizhang">
          <el-input v-model="ruleForm.yudingshizhang" 
              placeholder="预订时长" clearable  :readonly="ro.yudingshizhang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="预订时长" prop="yudingshizhang">
              <el-input v-model="ruleForm.yudingshizhang" 
                placeholder="预订时长" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chufangmingcheng = true;
          ...
          if(o=='yudingdingjin'){
            this.ruleForm.yudingdingjin = obj[o];
	    this.ro.yudingdingjin = true;
            continue;
          }
          if(o=='shifouyuding'){
            this.ruleForm.shifouyuding = obj[o];
	    this.ro.shifouyuding = true;
            continue;
          }
          if(o=='yudingshijian'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.shifouyudingOptions = "是,否".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
        url: `chufangyuding/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `chufangyuding/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chufangyudingCrossAddOrUpdateFlag = false;
                  this.parent.search();
