<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="应付金额" prop="yingfujine">
            <el-input v-model="yingfujine"
                placeholder="应付金额" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yingfujine" label="应付金额" prop="yingfujine">
              <el-input v-model="ruleForm.yingfujine" 
                placeholder="应付金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
...
export default {
  ...
  computed: {
    yingfujine: {
      get: function () {
        return 0+parseFloat(this.ruleForm.zongjia==""?0:this.ruleForm.zongjia)-parseFloat(this.ruleForm.yudingdingjin==""?0:this.ruleForm.yudingdingjin) || 0
      }
    },
  },
  created() {
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shiyongzhuangtaiOptions = "完成使用".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
