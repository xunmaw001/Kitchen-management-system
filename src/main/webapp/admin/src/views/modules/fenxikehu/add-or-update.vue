<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="客户数量" prop="kehushuliang">
          <el-input v-model="ruleForm.kehushuliang" 
              placeholder="客户数量" clearable  :readonly="ro.kehushuliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="客户数量" prop="kehushuliang">
              <el-input v-model="ruleForm.kehushuliang" 
                placeholder="客户数量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tongjibianhao = true;
          ...
          if(o=='kehushuliang'){
            this.ruleForm.kehushuliang = obj[o];
	    this.ro.kehushuliang = true;
            continue;
          }
          if(o=='dengjiriqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `fenxikehu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fenxikehuCrossAddOrUpdateFlag = false;
                  this.parent.search();
