<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="厨房评价" prop="chufangpingjia">
          <el-select v-model="ruleForm.chufangpingjia" placeholder="请选择厨房评价">
            <el-option
                v-for="(item,index) in chufangpingjiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="厨房评价" prop="chufangpingjia">
	      <el-input v-model="ruleForm.chufangpingjia"
                placeholder="厨房评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.pingjiabianhao = true;
          ...
          if(o=='chufangpingjia'){
            this.ruleForm.chufangpingjia = obj[o];
	    this.ro.chufangpingjia = true;
            continue;
          }
          if(o=='fuwupingjia'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.chufangpingjiaOptions = "★,★★,★★★,★★★★,★★★★★".split(',')
