...
public class ChufangxinxiController {
    ...
    public R query(ChufangxinxiEntity chufangxinxi){
		...
		return R.ok("查询厨房信息成功").put("data", chufangxinxiView);
    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		chufangxinxi.setClicknum(chufangxinxi.getClicknum()+1);
		chufangxinxi.setClicktime(new Date());
		chufangxinxiService.updateById(chufangxinxi);
    ...
    public R autoSort(@RequestParam Map<String, Object> params,ChufangxinxiEntity chufangxinxi, HttpServletRequest request,String pre){
        EntityWrapper<ChufangxinxiEntity> ew = new EntityWrapper<ChufangxinxiEntity>();
